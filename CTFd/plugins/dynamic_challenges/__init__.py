...
class DynamicChallenge(Challenges):
    __mapper_args__ = {"polymorphic_identity": "dynamic_value"}
    id = db.Column(
...
class DynamicValueChallenge(BaseChallenge):
    id = "dynamic_value"  # Unique identifier used to register challenges
    name = "dynamic_value"  # Name of a challenge type
    templates = (
...
def load(app):
    ...
    CHALLENGE_CLASSES["dynamic_value"] = DynamicValueChallenge
